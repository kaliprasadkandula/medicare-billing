		...
		<div class="row">
			<div class="col-sm-5 mx-auto mt-2">
				<div class="card shadow">
					...
					<div class="card-body">
						<form method="post" action="raiseticket">
							...
							<label class="col-sm-4 col-form-label">Enter Query</label>
								
								<div class="col-sm-8">
								 <textarea name="query" required class="form-control form-control-sm"> </textarea>
